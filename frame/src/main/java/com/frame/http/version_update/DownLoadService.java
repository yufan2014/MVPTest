...
import com.frame.R;
import com.frame.http.version_update.fileload.FileCallback;
import com.frame.http.version_update.fileload.FileResponseBody;
...
public class DownLoadService extends Service {
    ...
    private String  destFileDir = Environment.getExternalStorageDirectory().getAbsolutePath() + File
            .separator + "DOWNLOAD_DEFAULT_DIR";
    /**
     * 目标文件存储的文件名
     */
    private String destFileName = "XXX.apk";
    private String title = "";
    private String dwonload_url = "";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        dwonload_url = intent.getStringExtra("dwonload_url");
        loadFile();
