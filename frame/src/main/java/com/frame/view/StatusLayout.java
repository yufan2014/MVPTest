...
public class StatusLayout extends RelativeLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        loadingStateProgressBarWidth =
                typedArray.getDimensionPixelSize(R.styleable.StatusLayout_loadingProgressBarWidth, 250);

        loadingStateProgressBarHeight =
                typedArray.getDimensionPixelSize(R.styleable.StatusLayout_loadingProgressBarHeight, 250);
